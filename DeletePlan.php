...
if(isset($_REQUEST['planID'])){
    ...
    if (mysqli_num_rows($result) <= 0)
        die("The plan you entered has been already deleted.<br>");
    $query = "DELETE FROM healthy_plan where healthy_plan_id = '$planID'";
    $result = mysqli_query($connection, $query);

    $query2 = "SELECT * FROM healthy_plan where healthy_plan_id = '$planID'";
